...
public class TurfWar extends PApplet {
    ...
    class Player {
         ...
         * as parameters and initializes them using the this keyword. DONE
         */
     ...
     * Do not initialize them yet. DONE
     */
    ...
    public void setup() {
        ...
        // 6. Set the background color. DONE
        //DOWN BELOW IS THE BLUE COLOR AND YES I TYPED THIS MESSAGE 
       background(135,206,235);

        // 7. Call the noStroke Method. DONE
        noStroke();
